...
![](https://tc.ets2la.cn/25-12/20251202103155.png)  
如果你双击打开C++ runtime的安装程序是这样的，这表明你已经有了基础的环境，直接点击 `关闭`即可。
![](https://tc.ets2la.cn/25-12/20251202094207.png)

::: tip 提示
仍如果你在安装 **C++ runtime** 时出现了下面的提示表明你的电脑中已经包含了，可直接进行下一步操作
![](https://tc.ets2la.cn/25-12/1a49706397ee2673d845797495d53fcb.png)
:::
...
![](https://tc.ets2la.cn/25-12/20251202105027.png)
::: tip 提示
...
![](https://tc.ets2la.cn/25-12/20251202125608.png)  
之后会进入到安装向导，点击`下一步`即可  
![](https://tc.ets2la.cn/25-12/20251202125735.png)  
点击`我接受`以同意许可协议  
![](https://tc.ets2la.cn/25-12/20251202125809.png)  
勾选`我已知晓，若曾为此安装程序付费，即表示我已受骗`并点击`下一步`  
![](https://tc.ets2la.cn/25-12/20251202125900.png)  
::: warning ⚠️注意
...
![](https://tc.ets2la.cn/25-12/20251202130133.png)  
仓库地址选择`CNB`,Pypi Mirror选择`USTC`或`Aliyun`，然后点击下一步  
![](https://tc.ets2la.cn/25-12/20251202130358.png)  
根据自己需要选择是否创建`开始菜单快捷方式和桌面快捷方式`，然后点击安装  
![](https://tc.ets2la.cn/25-12/20251202130552.png)  
安装过程中点击`显示详情`可以查看安装进度，点击`显示详情`也是在安装出现问题时最直接能够看出问题出现在什么地方的方式
![](https://tc.ets2la.cn/25-12/20251202130738.png)  
当出现这样的内容时，稍作等待，最终需要的时间取决于各位的硬盘速度以及网络环境  
![](https://tc.ets2la.cn/25-12/20251202131000.png)  
安装完成后**取消**勾选`启动ETS2LA`，然后点击完成  
![](https://tc.ets2la.cn/25-12/20251202131048.png)
::: tip 提示
