...
::: tip 提示
仍如果你在安装 **C++ runtime** 时出现了下面的提示表明你的电脑中已经包含了，可直接进行下一步操作
![](https://tc.ets2la.cn/d/img/25-12/1a49706397ee2673d845797495d53fcb.png)
:::
...
::: warning ⚠️注意
目前闲鱼已有多个商家出现了ETS2LA的安装服务，这并不是ETS2LA官方的安装服务，也不是ETS2LA的开发团队提供的安装服务，同时我们也不会提供任何形式的安装服务；
请**不要**使用这些商家的安装服务，使用这类服务导致您的电脑/游戏出现的任何问题均不负责。
<font color="#ff0000">PS</font>：交流群内的所说的远程安装服务一律收费250均为调侃，请注意甄别
::: 
